...
const Profile = () => {
    ...
    let datos:any=[
        {
            ...
            imagenPortada:"https://yesofcorsa.com/wp-content/uploads/2020/05/4K-Landscape-Best-Wallpaper-1024x576.jpg",
            username:"birulboy",
            post:5,
            followers:355,
            followed:30,
    ...
    return (
        <main className="bg-darkVoid w-full min-h-screen">
           <div className="contenedorP">
           <section  className="bg-cover bg-center bg-no-repeat relative mb-36" 
                    style={{
                ...
                <img className="rounded-full xl:w-96 xl:h-96 border-2 " src={datos[id].imagePerfil}  alt="imagen" />
                <h3 className="text-3xl text-blancoHueso mx-auto  mt-3  absolute left-24 Ro" >{datos[id].username}</h3>
                </div>
                
            </section >
                    <div className="mt-6">
                    <button className="text-blancoHueso text-3xl ml-36 flex items-center"><FaPencilAlt className="mr-2"/>Edit profile</button>
                    </div>
